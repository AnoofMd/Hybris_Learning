 ...
 */
package sample.webservice.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import sample.webservice.constants.YcommercewebservicesConstants;
import sample.webservice.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "sampleextension.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "sampleextension.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "sampleextension.oauth2.tokenUrl";

	private static final String DESC = "sampleextension.v2.description";
	private static final String TITLE = "sampleextension.v2.title";
	private static final String VERSION = "sampleextension.v2.version";
	private static final String LICENSE = "sampleextension.v2.license";
	private static final String LICENSE_URL = "sampleextension.v2.license.url";
	...
	private static final String LEGACY_CONTENT_NEGOTIATION = "sampleextension.content.negotiation.legacy";
