...
import sample.webservice.order.data.CardTypeDataList;
import sample.webservice.storesession.data.CurrencyDataList;
import sample.webservice.storesession.data.LanguageDataList;
import sample.webservice.user.data.CountryDataList;
import sample.webservice.user.data.TitleDataList;
