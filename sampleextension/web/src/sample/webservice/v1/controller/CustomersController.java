...
import sample.webservice.populator.HttpRequestAddressDataPopulator;
import sample.webservice.populator.HttpRequestCustomerDataPopulator;
...
import sample.webservice.user.data.AddressDataList;
import sample.webservice.user.data.LoginChangeResponse;
import sample.webservice.user.data.PasswordRestoreResponse;
import sample.webservice.validation.data.AddressValidationData;
