...
import static sample.webservice.constants.YcommercewebservicesConstants.ENUM_VALUES_SEPARATOR;
...
import sample.webservice.product.data.ProductDataList;
import sample.webservice.product.data.SuggestionDataList;
import sample.webservice.queues.data.ProductExpressUpdateElementData;
import sample.webservice.queues.data.ProductExpressUpdateElementDataList;
import sample.webservice.queues.impl.ProductExpressUpdateQueue;
import sample.webservice.stock.CommerceStockFacade;
import sample.webservice.util.ws.SearchQueryCodec;
...
public class ProductsController extends BaseController
{
	 ...
	 * {@link sample.webservice.populator.HttpRequestReviewDataPopulator} to populate review data
